...
public class VaultScreen extends HandledScreen<ScreenHandler> {
    ...
    protected void drawBackground(MatrixStack matrices, float delta, int mouseX, int mouseY) {
        ...
        drawTexture(matrices, x, y, 0, 0, backgroundWidth+7, backgroundHeight+18);
    }
    ...
    protected void init() {
        super.init();
        // Effectively disable the "Inventory" and "Vault" titles when opening a Vault
        titleX = width;
        titleY = height;
        playerInventoryTitleX = width;
        playerInventoryTitleY = height;
    }
}